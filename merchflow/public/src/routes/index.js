...
export const RoutedContent = () => {
    return (
        <Switch>
            <Redirect from="/" to="/dashboards/maindashboard" exact />
            
            <Route path="/dashboards/analytics" exact component={Analytics} />
            <Route path="/dashboards/maindashboard" exact component={MainDashboard} />
            ...
            <Route component={ DeliveryForm } path="/forms/delivery-form" />
            ...
            <Route component={ FormResult } path="/tables/form-result" />
